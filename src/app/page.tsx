...
export default function Home() {
  ...
  return (
    <div >
       ...
       {/* <br/> */}
       {/* <hr></hr>  */}
       <button onClick={()=>{setshow(!show);setclickcount(5);setscor1(0); {GlobalVer.scor=0} }} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-3 rounded-e-full ml-2 " >
 On-Off </button>
 <div>
